            ...
            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                <div class="text-center">
                   <p class="fs-5 fw-bold text-primary"></p>
                    <h1 class="display-5 mb-4">Youth Motion Kenya is an inter-County youth forum for business networking on trade development and investment promotion in the 47 Counties of Kenya. It was formally registered under the Ministry of Social Affairs in 2016 and works closely with the State Department for Youth Affairs.</h1>
                    <!--<a class="btn btn-primary py-3 px-4" href="#">Explore More</a>-->
                </div>
            </div>
            <div class="col-lg-12">
                <div class="row g-4">
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 120px; height: 120px; line-height: 120px;">
                           <h3 class="mb-0">Vision</h3>
                         </div>

                            <p class="mb-0">A motivated, productive, self-sustaining, and progressive Kenyan youth population free from abject poverty.</p>
                        </div>
                    </div>
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 120px; height: 120px; line-height: 120px;">
                           <h3 class="mb-0">Mission</h3>
                            ...
                            <p class="mb-0">To champion societal responsibility through innovation and entrepreneurship for socioeconomic transformation to the youth, powering Africa’s prosperity through integration.</p>
                        </div>
                    </div>
                    <div class="col-md-12 wow fadeIn" data-wow-delay="0.7s">
                        <div class="text-center rounded py-5 px-4" style="box-shadow: 0 0 45px rgba(0,0,0,.08);">
                        <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 140px; height: 140px; line-height: 140px;">
                           <h3 class="mb-0">Objectives</h3>
                         </div>
                            <p class="mb-0 align-items-center">
                            <ul>
                            <li>To leverage the power of art in fostering the culture of innovation and entrepreneurship among the youth in and out of school.</li> 
                            <li>To formulate skill development interventions that build mental capacity in youth to challenge and solve socioeconomic problems within communities. </li> 
                            <li> To pursue gainful exchange programs and partnerships with strategic organizations with an aim to promote Agenda 2063 and the Sustainable Development Goals (SDGs).</li> 
                              </ul>
                         </p>
                        </div>
                    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item rounded d-flex h-100">
                    ...
                    <div class="service-text rounded p-4" style="max-width: 300px;">
                        <div class="btn-square rounded-circle mx-auto mb-3">
                            <img class="img-fluid" src="admin/uploads/<?php echo $SERVICES['icon'];?>" alt="Icon">
                        </div>
                        <h4 class="mb-3" style="max-width: 200px;"><?php echo $SERVICES['name'];?></h4>
                        <p class="mb-4" style="max-width: 300px; overflow: hidden; text-overflow: ellipsis;"><?php echo strip_tags($SERVICES['description']);?></p>
